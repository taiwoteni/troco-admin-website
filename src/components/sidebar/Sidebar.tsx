...
export default function SideBar() {
  ...
  return (
    <div className={`flex h-screen overflow-x-hidden flex-col bg-white shadow-sm gap-3 ${expand? 'w-[285px]': 'w-[103px]'} ease duration-500 transition-all allow-discrete`}>
              ...
              <div key={item.path} style={{marginTop:index===0?'40px':'0'}} className='flex px-5 overflow-hidden items-center'>
